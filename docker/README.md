...
| Solr REST API            | http://localhost:8983/solr/\<core\>/select, .../update | REST API used internally by NDEx for indexing and search. Primary cores: `ndex-nfs`, `ndex-networks`, `ndex-users`.                             |
