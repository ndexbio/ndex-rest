...
public class TestGlobalNetworkIndexManager {
    ...
    public void testPrepareIndexDocument_PublicVisibility_NoPermissionFields() {
        ...
        manager.prepareIndexDocument(s, VisibilityType.PUBLIC);
    ...
    public void testPrepareIndexDocument_PrivateVisibility_WritesNoAccessList() {
        ...
        manager.prepareIndexDocument(s, VisibilityType.PRIVATE);
    ...
    public void testCreateIndex_PublicNetwork_CommitsToPublicCore() throws Exception {
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.createIndex(s, VisibilityType.PUBLIC);
    ...
    public void testCreateIndex_PrivateNetwork_CommitsToPrivateCore() throws Exception {
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.createIndex(s, VisibilityType.PRIVATE);
    ...
    @Test
    public void testDelete_PublicNetwork_RemovesFromTheSingleCore() throws Exception {
        mockWrapper = createMock(SolrClientWrapper.class);
        Capture<String> coreCapture = Capture.newInstance();
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.delete("network-uuid-123");
    ...
    public void testSearch_PublicCore_WritePermission_FiltersToOwnedAndEditable() throws Exception {
        ...
        String[] fq = queryCapture.getValue().getFilterQueries();
        // Assert on the permission portion alone. The trailing " AND (visibility:(PUBLIC OR UNLISTED))"
        // is the caller's own narrowing, which legitimately names UNLISTED: visibility=PUBLIC selects
        // the partition the old public core held, and that included the caller's own unlisted files.
        String permissionPart = fq[0].substring(0, fq[0].indexOf(" AND (visibility:("));
        assertTrue(permissionPart, permissionPart.contains("owner:\"bob\""));
        assertFalse(permissionPart, permissionPart.contains("userEdit"));
        assertFalse(permissionPart, permissionPart.contains("userRead"));
        // A WRITE search drops the public arm entirely: public visibility grants no edit.
        assertFalse(permissionPart, permissionPart.contains("visibility:PUBLIC"));
    }
    ...
    public void testSearchByType_AddsEntityTypeFilter() throws Exception {
        ...
        manager.searchByType("test", "user", VisibilityType.PUBLIC, 10, 0,
                null, null, "NETWORK", true, SearchScope.EMPTY);
    ...
    public void testSearchByType_IncludeShortcutsFalse_OmitsShortcutClause() throws Exception {
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.searchByType("test", "user", VisibilityType.PUBLIC, 10, 0,
                null, null, "NETWORK", false, SearchScope.EMPTY);
    ...
    public void testSearch_Integration() throws Exception {
        ...
        manager.createIndex(cancer, VisibilityType.PUBLIC);
        ...
        SolrDocumentList results = manager.searchByType("cancer", "testOwner", VisibilityType.PUBLIC,
                100, 0, null, null, "NETWORK", true, SearchScope.EMPTY);
    ...
    public void testSearch_WithAdminFilter_Integration() throws Exception {
        ...
        s1.setOwner("owner1");
        manager.createIndex(s1, VisibilityType.PUBLIC);

        NetworkSummary s2 = createTestSummary("Their Network", "Owned by them");
        s2.setOwner("owner2");
        manager.createIndex(s2, VisibilityType.PUBLIC);

        Thread.sleep(2000);

        SolrDocumentList results = manager.search("*:*", "owner1", VisibilityType.PUBLIC,
                100, 0, "owner1", Permissions.ADMIN, SearchScope.EMPTY);
    ...
    public void testSearch_PrivateVisibility_Integration() throws Exception {
        ...
        SolrDocumentList anonResults = manager.search("*:*", null, VisibilityType.PRIVATE,
                100, 0, null, null, SearchScope.EMPTY);
    ...
    public void testSearch_OnlyReturnsNetworks_Integration() throws Exception {
        ...
        manager.createIndex(network, VisibilityType.PUBLIC);
    ...
    public void testSearch_OwnerFilterInjection_IsEscaped() throws Exception {
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.search("*:*", null, VisibilityType.PUBLIC, 10, 0, injection, null, SearchScope.EMPTY);
    ...
    public void testSearch_PrivateCore_UserAccountInjection_IsEscaped() throws Exception {
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.search("*:*", injection, VisibilityType.PRIVATE, 10, 0, null, Permissions.READ, SearchScope.EMPTY);
    ...
    public void testSearchByType_OwnerFilterInjection_IsEscaped() throws Exception {
        ...
        manager = new GlobalNetworkIndexManager(mockWrapper);
        manager.searchByType("*:*", null, VisibilityType.PUBLIC, 10, 0, injection, null, "NETWORK", true, SearchScope.EMPTY);
