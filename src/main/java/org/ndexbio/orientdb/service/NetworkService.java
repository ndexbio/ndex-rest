...
public class NetworkService extends NdexService
{
    ...
    **************************************************************************/
    ...
    public User resolveUserUserByUsername(String userName) {
		...
		try {
			...
			return  (User) result.getResults().iterator().next();
    ...
    **************************************************************************/
    ...
    public void deleteNetwork(final String networkJid) throws NdexException
    {
    ...
    **************************************************************************/
    ...
    public Network getNetwork(final String networkJid) throws NdexException
    {
        if (networkJid == null || networkJid.isEmpty())
            throw new ValidationException("No network ID was specified.");
    ...
    **************************************************************************/
    ...
    public Network getEdges(final String networkJid, final int skip, 
    		final int top) throws NdexException
    {
        if (networkJid == null || networkJid.isEmpty())
            throw new ValidationException("No network ID was specified.");
        else if (top < 1)
    ...
    **************************************************************************/
    ...
    public Network queryNetwork(final String networkJid,
    		final NetworkQueryParameters queryParameters) throws Exception
    {
        final ORID networkRid = RidConverter.convertToRid(networkJid);
